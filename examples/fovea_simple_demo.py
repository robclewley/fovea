"""
This is the main run script for Feature-based Optimization with Visual
Environment Assistance (FOVEA) package.

gui and plotter objects are global and imported from diagnostics module
